...
/// <summary> Animation Curve with with built in timer and easily accesible duration and scale. </summary>
[System.Serializable]
public class SmartCurve {
    ...
    - can use all deltaTime variants
    */
    ...
    /// <summary> Duplicates and returns the curve. </summary>
...
/// <summary> Allows for stringing multiple smart curves together, each with separate characteristics. </summary>
[System.Serializable]
public class SmartCurveComposite {
    ...
    /// <summary> Evaluates for the current curve. Continues to next curve if auto-continue is enabled. </summary>
    public float Evaluate() {
    ...
    /// <summary> Duplicates and returns the smart curve composite </summary>
    public SmartCurveComposite Copy() => new SmartCurveComposite(curves);
    /// <summary> Starts the smart curve composite. </summary>
    /// <param name="startAt"> Start at a specific curve. </param>
    ...
    /// <summary> Progress to the next curve. </summary>
    public void Continue() {
        currentCurve++;
        doneWithCurrentCurve = false;
    }
    /// <summary> Stops the smart curve composite. </summary>
    public void Stop() {
        currentCurve = curves.Length - 1;
        foreach (SmartCurve c in curves) c.Stop();
    }
    /// <summary> Specifies whether the current curve has finished. </summary>
